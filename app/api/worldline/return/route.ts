...
export async function GET(req) {
  ...
  <html><head><meta charset="utf-8"><title>Booking Successful</title>
  <meta name="viewport" content="width=device-width, initial-scale=1"/>
  <style>body{font-family:system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;padding:2rem}
  .box{max-width:700px;margin:0 auto}</style></head>
  <body><div class="box"><h1>Booking Successful</h1>
