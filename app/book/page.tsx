...
export default function BookPage() {
  ...
  const [region, setRegion]   = useState('Auckland');  // default to a region that has slots
  ...
  // Only show slots matching the picked date's weekday
